<?php
    ...
    $this->title = $translator->translate('Offers'); 
?>
<div class="row" style="margin-top: 10px;">
    <div class="col-md-12">
        <h3> <?= $translator->translate('Offers') ?> </h3>
    </div>
</div>
<div class="row" style="margin-top: 10px;">
    <div class="col-md-10">
    ...
    <script>  
        ...
        Vue.component('Product', {
            ...
            <div class="row product">
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12" style="height: 100px;">                          
                            <img class="product-image" style='margin-top: 10px; height: 100%; width: 100%; object-fit: contain' :src="'http://admin.eshop.local/uploads/' + product.id">
                        </div>
                    </div>
                ...
                <div class="col-md-2">
                    <div style="padding-top: 50%; padding-left: 30%;">
